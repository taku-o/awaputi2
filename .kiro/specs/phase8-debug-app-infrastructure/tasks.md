...
#### 1.1 デバッグ用トップページコンポーネントの作成
- [ ] **Task 1.1.1**: `DebugTopPage.tsx`コンポーネントの作成
  - ファイル: `packages/bubblepop/src/pages/DebugTopPage.tsx`
  - 内容: 各デバッグアプリへのリンクを提供するトップページ
  - 受け入れ基準:
    - デバッグアプリ一覧が表示される
    - 各アプリへのリンクが機能する
    - 視覚的に分かりやすいUIが実装されている

- [ ] **Task 1.1.2**: デバッグアプリ情報の定義
  - 内容: 各デバッグアプリの情報（名前、説明、URL、ポート）を定義
  - 受け入れ基準:
    - 6つのデバッグアプリの情報が正しく定義されている
    - 各アプリのポート番号が正しく設定されている

#### 1.2 ルーティング設定の拡張
- [ ] **Task 1.2.1**: デバッグ用ルートの追加
  - ファイル: `packages/bubblepop/src/router/Router.tsx`
  - 内容: `/debug`ルートを追加してDebugTopPageを表示
  - 受け入れ基準:
    - `/debug`にアクセスするとDebugTopPageが表示される
    - 既存のルーティングに影響しない

### 2. デバッグアプリの作成

#### 2.1 ゲームプレイデバッグアプリの作成
- [ ] **Task 2.1.1**: パッケージディレクトリの作成
...
- [ ] **Task 2.1.6**: デバッグ用トップページコンポーネントの作成
...
- [ ] **Task 2.2.6**: デバッグ用トップページコンポーネントの作成
...
- [ ] **Task 2.3.6**: デバッグ用トップページコンポーネントの作成
...
#### 2.4 アカウント画面デバッグアプリの作成
- [ ] **Task 2.4.1**: パッケージディレクトリの作成
...
- [ ] **Task 2.4.6**: デバッグ用トップページコンポーネントの作成
...
#### 2.5 ショップ画面デバッグアプリの作成
- [ ] **Task 2.5.1**: パッケージディレクトリの作成
...
- [ ] **Task 2.5.6**: デバッグ用トップページコンポーネントの作成
...
- [ ] **Task 2.6.6**: デバッグ用トップページコンポーネントの作成
...
#### 3.1 本番アプリのテスト
- [ ] **Task 3.1.1**: デバッグ用トップページの表示テスト
  - 内容: `/debug`にアクセスしてDebugTopPageが表示されることを確認
  - 受け入れ基準:
    - デバッグ用トップページが正しく表示される
    - 各デバッグアプリへのリンクが表示される

- [ ] **Task 3.1.2**: デバッグアプリリンクの動作テスト
  - 内容: 各デバッグアプリへのリンクが正しく動作することを確認
  - 受け入れ基準:
    - 各デバッグアプリが正しいポートで起動する
    - リンクが正しく動作する

#### 3.2 各デバッグアプリのテスト
- [ ] **Task 3.2.1**: ゲームプレイデバッグアプリのテスト
...
### 全体の受け入れ基準
1. 本番アプリにデバッグ用トップページが追加される
2. 6つのデバッグアプリが独立したポートで起動する
