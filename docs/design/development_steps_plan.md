...
1. 基本的な泡の表示（1種類）
2. クリックで泡を消す機能
3. 泡の自然移動システム実装（緩やかなランダム移動）
4. 泡の呼吸システム実装（サイズ変化アニメーション）
5. 境界反発システム実装（画面端での反発処理）
6. 年齢による物理特性変化システム実装
7. 泡の生成システム
...
3. 累計AP、TAP計算
4. ユーザーレベル計算
5. レベル特典システム実装（レベル5: 最大HP120、開始アイテム「slowTime」等）
6. アンロック条件の複合判定システム実装
7. TAPマイルストーン報酬システム実装
...
3. 実績達成通知
4. AP報酬付与
5. 進捗追跡システム実装（実績達成までの進捗率表示）
6. カテゴリ管理システム実装（基本プレイ、スコア、コンボ等）
7. レア度システム実装
8. バッチ処理システム実装（複数実績の効率的なチェック）
